...
namespace MusicStore.Web.Controllers
{
    public class TicketsController : Controller
    {
        ...
        public TicketsController(ITicketService productService, IShoppingCartService shoppingCartService, IMovieService movieService)
        {
        ...
        {
            ViewBag.MovieId = new SelectList(_movieService.GetAllMovies(), "Id", "MovieName");
            return View();
        }
        ...
        [Authorize]
        public IActionResult Create([Bind("Id,MovieId,Price,Rating")] Ticket product)
        {
        ...
        [ValidateAntiForgeryToken]
        [Authorize]
        public ActionResult Edit(Guid id, [Bind("Id,MovieId,Price,Rating")] Ticket product)
        {
            if (id != product.Id)
            {
                return NotFound();
